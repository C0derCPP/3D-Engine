...
class Quaternion
{
    public:
        ...
        Quaternion get_local_rotation(Vector4 vec4);
        Quaternion get_local_rotation(GLfloat w, GLfloat x, GLfloat y, GLfloat z);
        Matrix4 get_quaternion_matrix();
...
inline Quaternion::Quaternion(GLfloat w, GLfloat x, GLfloat y, GLfloat z)
{
    axis.w = w;
    axis.x = x;
    axis.y = y;
...
inline Quaternion Quaternion::get_local_rotation(Vector4 vec4)
{
    Quaternion local;
    //////////////////////////////////////
...
inline Quaternion Quaternion::get_local_rotation(GLfloat w, GLfloat x, GLfloat y, GLfloat z)
{
...
inline Matrix4 Quaternion::get_quaternion_matrix()
{
    mat4x4 mat4;
    //column 1
    ///////////////////////////////////////////////////////////////////////
